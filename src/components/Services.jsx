            ...
            <div className='container'>
                ...
                <div className='relative'>
                    <div className='relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]'>
                        ...
                        <Generating className='absolute bottom-4 right-4 left-4 border border-n-1/10 lg:left-1/2 lg-right-auto lg:bottom-8 lg:-translate-x-1/2' />
                    </div>
                                ...
                                <ul className='flex items-center justify-between'>
                                    {brainwaveServicesIcons.map((icon, index) => (
                                        <li
                                            ...
                                            ${index === 2 ? 'rounded-2xl w-[3rem] h-[3rem] p-0.25 bg-conic-gradient md:w-[4.5rem] md:h-[4.5rem]'
                                            :
